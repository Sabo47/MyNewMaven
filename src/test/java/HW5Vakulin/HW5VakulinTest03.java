...
public class HW5VakulinTest03 extends AbstractTest {
    ...
    void myActiontest() throws InterruptedException {
        ...
        Assertions.assertTrue(getDriver().getTitle().contains("книги"), "The website is not found.");
...
//        webElement4.click();
        ...
        search.click(getDriver().findElement(By.id("auth_form-login-input")))
                .pause(10000l)
                .sendKeys(getDriver().findElement(By.id("auth_form-login-input")),"MyLenin@mail.ru")
                .pause(10000l)
                .sendKeys(getDriver().findElement(By.id("auth_form-password-input")),"Qq123456")
